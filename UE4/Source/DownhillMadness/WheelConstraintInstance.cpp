...
#include "WheelConstraintInstance.h"

#define LOCTEXT_NAMESPACE "WheelConstraintInstance"
...
/** Constructor **/
FWheelConstraintInstance::FWheelConstraintInstance()
: ConstraintIndex(0)
, OwnerComponent(NULL)
#if WITH_PHYSX
, ConstraintData(NULL)
...
*/
void FWheelConstraintInstance::InitConstraint(USceneComponent* Owner, FBodyInstance* Body1, FBodyInstance* Body2, float Scale)
{
	...
	if (PD6Joint == NULL)
	{
		UE_LOG(LogPhysics, Log, TEXT("URB_WheelConstraintInstance::InitConstraint - Invalid 6DOF joint (%s)"), *JointName.ToString());
		return;
	}
	...
	{
		UE_LOG(LogPhysics, Log, TEXT("URB_WheelConstraintInstance::InitConstraint: PxScene has inconsistent FPhysScene userData.  No joint created."));
		return;
	}
...
void FWheelConstraintInstance::TermConstraint()
{
#if WITH_PHYSX
	if (!ConstraintData)
	{
...
bool FWheelConstraintInstance::IsTerminated() const
{
#if WITH_PHYSX
...
bool FWheelConstraintInstance::IsValidWheelConstraintInstance() const
{
#if WITH_PHYSX
	return ConstraintData != NULL;
#else
...
void FWheelConstraintInstance::CopyConstraintGeometryFrom(const FWheelConstraintInstance* FromInstance)
{
...
void FWheelConstraintInstance::CopyConstraintParamsFrom(const FWheelConstraintInstance* FromInstance)
{
#if WITH_PHYSX
...
FTransform FWheelConstraintInstance::GetRefFrame(EConstraintFrame::Type Frame) const
{
	FTransform Result;
	...
	if (Error > 0.01f)
	{
		UE_LOG(LogPhysics, Warning, TEXT("FWheelConstraintInstance::GetRefFrame : Contained scale."));
	}

	return Result;
}

void FWheelConstraintInstance::SetRefFrame(EConstraintFrame::Type Frame, const FTransform& RefFrame)
{
	if (Frame == EConstraintFrame::Frame1)
	{
...
FVector FWheelConstraintInstance::GetConstraintLocation()
{
#if WITH_PHYSX
...
void FWheelConstraintInstance::SetLinearPositionDrive(bool bEnableXDrive, bool bEnableYDrive, bool bEnableZDrive)
{
#if WITH_PHYSX
	PxD6Joint* Joint = (PxD6Joint*)ConstraintData;
...
void FWheelConstraintInstance::SetLinearVelocityDrive(bool bEnableXDrive, bool bEnableYDrive, bool bEnableZDrive)
{
#if WITH_PHYSX
	PxD6Joint* Joint = (PxD6Joint*)ConstraintData;
...
void FWheelConstraintInstance::SetAngularPositionDrive(bool bEnableSwingDrive, bool bEnableTwistDrive)
{
#if WITH_PHYSX
	PxD6Joint* Joint = (PxD6Joint*)ConstraintData;
	if (Joint &&  !(Joint->getConstraintFlags()&PxConstraintFlag::eBROKEN))
...
void FWheelConstraintInstance::SetAngularVelocityDrive(bool bEnableSwingDrive, bool bEnableTwistDrive)
{
#if WITH_PHYSX
	PxD6Joint* Joint = (PxD6Joint*)ConstraintData;
	if (Joint &&  !(Joint->getConstraintFlags()&PxConstraintFlag::eBROKEN))
...
void FWheelConstraintInstance::SetLinearPositionTarget(const FVector& InPosTarget)
{
...
void FWheelConstraintInstance::SetLinearVelocityTarget(const FVector& InVelTarget)
{
	// If settings are the same, don't do anything.
...
void FWheelConstraintInstance::SetLinearDriveParams(float InSpring, float InDamping, float InForceLimit)
{
#if WITH_PHYSX
	PxD6Joint* Joint = (PxD6Joint*)ConstraintData;
	if (Joint &&  !(Joint->getConstraintFlags()&PxConstraintFlag::eBROKEN))
...
void FWheelConstraintInstance::SetAngularOrientationTarget(const FQuat& InPosTarget)
{
...
void FWheelConstraintInstance::SetAngularVelocityTarget(const FVector& InVelTarget)
{
	// If settings are the same, don't do anything.
...
/** Function for setting angular motor parameters. */
void FWheelConstraintInstance::SetAngularDriveParams(float InSpring, float InDamping, float InForceLimit)
{
#if WITH_PHYSX
...
void FWheelConstraintInstance::SetAngularDOFLimitScale(float InSwing1LimitScale, float InSwing2LimitScale, float InTwistLimitScale)
{
#if WITH_PHYSX
	PxD6Joint* Joint = (PxD6Joint*)ConstraintData;
	if (Joint &&  !(Joint->getConstraintFlags()&PxConstraintFlag::eBROKEN))
...
void FWheelConstraintInstance::SetLinearLimitSize(float NewLimitSize)
{
#if WITH_PHYSX
	PxD6Joint* Joint = (PxD6Joint*)ConstraintData;
	if (Joint &&  !(Joint->getConstraintFlags()&PxConstraintFlag::eBROKEN))
...
void FWheelConstraintInstance::ConfigureAsHinge(bool bOverwriteLimits)
{
	LinearXMotion = LCM_Locked;
	LinearYMotion = LCM_Locked;
	LinearZMotion = LCM_Locked;
...
void FWheelConstraintInstance::ConfigureAsPrismatic(bool bOverwriteLimits)
{
...
void FWheelConstraintInstance::ConfigureAsSkelJoint(bool bOverwriteLimits)
{
	LinearXMotion = LCM_Locked;
	LinearYMotion = LCM_Locked;
	LinearZMotion = LCM_Locked;
...
void FWheelConstraintInstance::ConfigureAsBS(bool bOverwriteLimits)
{
	LinearXMotion = LCM_Locked;
	LinearYMotion = LCM_Locked;
	LinearZMotion = LCM_Locked;
...
bool FWheelConstraintInstance::IsHinge() const
{
	int32 AngularDOF = 0;
...
bool FWheelConstraintInstance::IsPrismatic() const
{
	int32 LinearDOF = 0;
...
bool FWheelConstraintInstance::IsSkelJoint() const
{
	return	LinearXMotion == LCM_Locked &&
		LinearYMotion == LCM_Locked &&
		LinearZMotion == LCM_Locked &&
...
bool FWheelConstraintInstance::IsBallAndSocket() const
{
	int32 AngularDOF = 0;
	AngularDOF += AngularSwing1Motion != ACM_Locked ? 1 : 0;
	AngularDOF += AngularSwing2Motion != ACM_Locked ? 1 : 0;
...
void FWheelConstraintInstance::PostSerialize(const FArchive& Ar)
{
...
void FWheelConstraintInstance::OnConstraintBroken()
{
