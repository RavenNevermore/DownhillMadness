...
#include "WheelConstraintComponent.generated.h"
...
*/
UCLASS(HeaderGroup = Component, ClassGroup = Physics, dependson(WheelConstraintInstance), MinimalAPI, meta = (BlueprintSpawnableComponent), HideCategories = (Activation, "Components|Activation", Physics, Mobility))
class UWheelConstraintComponent : public USceneComponent
{
...
public:
	...
	UPROPERTY(EditAnywhere, Category = ConstraintComponent, meta = (ShowOnlyInnerProperties))
		FWheelConstraintInstance			WheelConstraintInstance;
...
protected:
	...
	void OnConstraintBrokenHandler(FWheelConstraintInstance* BrokenConstraint);
};
