...
#include "Object.h"
#include "WheelConstraintInstance.generated.h"

/** Container for a physics representation of an object */
USTRUCT()
struct ENGINE_API FWheelConstraintInstance
{
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = AngularMotor)
		float AngularDriveForceLimit;    //	Due to the way the WheelConstraintInstance pooling works, this MUST BE LAST PROPERTY OF THE CLASS.
...
public:
	...
	bool IsValidWheelConstraintInstance() const;
	...
	// @todo document
	void CopyConstraintGeometryFrom(const FWheelConstraintInstance* FromInstance);

	// @todo document
	void CopyConstraintParamsFrom(const FWheelConstraintInstance* FromInstance);
...
template<>
struct TStructOpsTypeTraits<FWheelConstraintInstance> : public TStructOpsTypeTraitsBase
{
	enum
	{
